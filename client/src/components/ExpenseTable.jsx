...
export const ExpenseTable = ({
  ...
  return (
    <>
      {/* Mobile View: Clean, Touch-Friendly Expense Cards */}
        ...
        {displayedExpenses.map((expense) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center space-x-2 mt-1 flex-wrap gap-y-1">
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-semibold border ${badgeClass}`}
                    >
                      {expense.category}
                    </span>
              ...
              {/* Notes (if any) */}
              {expense.notes && (
                <div className="text-xs text-slate-500 bg-slate-50 p-2 rounded-lg flex items-start space-x-1.5 border border-slate-100">
              ...
              {showActions && (
                <div className="flex items-center justify-end space-x-2 pt-2 border-t border-slate-100">
                  <Link
                    ...
                    className="inline-flex items-center px-2.5 py-1 text-xs font-semibold text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors border border-slate-200"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-2.5 py-1 text-xs font-semibold text-rose-600 hover:bg-rose-50 rounded-lg transition-colors border border-rose-200"
                  >
